...
const ShopNowButton:React.FC<ShopNowButtonProps> = ({ onShopnow, className }) => (
  <button
...
const PromotionalBanners = ({
  ...
  return (
    <div className="h-[700px] mx-auto p-4 grid grid-cols-1 md:grid-cols-2 font-jost text-right">
      {/* Top Left Banner: Smartwatch */}
      <Card className="relative min-h-[300px] bg-cover flex items-center p-8 overflow-hidden col-span-1">
        ...
        <div className="relative z-10 flex flex-col justify-end w-full md:w-1/2 ml-auto text-center md:text-left items-center md:items-start">
          <span className="text-sm font-normal leading-5 text-gray-600 mb-2">
            EXCLUSIVE COUPON
          </span>
          <h2 className="text-5xl font-normal mb-4 leading-tight text-white md:text-black">
            Top Electronic Deals
          </h2>
          <p className="text-sm text-gray-700 mb-6 md:text-gray-700">
            SAVE UP TO $199 OFF, GET CHANCE!
          </p>
          <ShopNowButton onShopnow={onShopnow} />
        </div>
      </Card>
      ...
      <div className="grid grid-rows-2 col-span-1">
        ...
        <Card className="relative bg-cover min-h-[150px] flex items-center p-6 overflow-hidden">
          <div className="relative z-10 w-1/2 pl-4 text-left">
