...
// A reusable component for each individual feature item
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <FeatureItem
          icon={
            ...
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75H19.5a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H10.5a2.25 2.25 0 0 0-2.25 2.25v1.5m-3 9a2.25 2.25 0 0 0 2.25 2.25H12M9 12H4.5A2.25 2.25 0 0 0 2.25 14.25v5.25m10.5-12H18a2.25 2.25 0 0 1 2.25 2.25v6.25M10.5 6H12v6H6V6h4.5Zm0 12H6v-6h4.5v6Z" />
            </svg>
          }
        ...
        <FeatureItem
          icon={
            <svg
              ...
              className="w-16 h-16 border border-gray-400 p-2 rounded-full"
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.454-1.603 3.39M18.667 8.046L16.25 4.5M3.75 12a9.75 9.75 0 0 1 1.074-4.54A10.05 10.05 0 0 0 3 12c0 2.839 1.144 5.437 2.992 7.375M21 12a9.75 9.75 0 0 0-1.895-6.046M11.75 4.5L14.167 8.046M12 21a9.75 9.75 0 0 0 6.183-2.126M12 21a9.75 9.75 0 0 1-6.183-2.126M10.5 6.75L7.5 3" />
            </svg>
          }
